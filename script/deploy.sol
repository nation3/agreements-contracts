...
contract DeployStack is Script, DeploymentUtils {
    ...
    function setUpArbitrator() internal {
        if (ARBITRATOR == address(0)) {
            ...
            arbitrator.setUp(RESOLUTION_LOCK_PERIOD, true, DepositConfig(arbitrationToken, APPEAL_COST, tx.origin));
    ...
    function setUpFramework() internal {
        ...
        CollateralAgreementFramework framework = new CollateralAgreementFramework{salt: SALT}(Permit2(PERMIT2), tx.origin);
