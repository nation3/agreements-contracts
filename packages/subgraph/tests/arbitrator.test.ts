...
describe("handling of submitResolution", () => {
    ...
    test("resolution submitted", () => {
        ...
        assert.fieldEquals("Settlement", submitted.params.settlement.toHexString(), "dispute", submitted.params.dispute.toHexString());
        assert.fieldEquals("Settlement", submitted.params.settlement.toHexString(), "status", "Submitted");
        assert.fieldEquals("Settlement", submitted.params.settlement.toHexString(), "submittedAt", submitted.block.timestamp.toString())
        assert.fieldEquals("Dispute", submitted.params.dispute.toHexString(), "settlement", submitted.params.settlement.toHexString());
    });
    ...
    describe("one resolution submitted", () => {
        ...
        test("resolution appealed", () => {
            ...
            assert.fieldEquals("Settlement", appealed.params.settlement.toHexString(), "status", "Appealed");
        });
        ...
        test("resolution endorsed", () => {
            ...
            assert.fieldEquals("Settlement", endorsed.params.settlement.toHexString(), "status", "Endorsed");
        });
        ...
        test("resolution executed", () => {
            ...
            assert.fieldEquals("Settlement", executed.params.settlement.toHexString(), "status", "Executed");
        });
        ...
        test("new resolution submitted", () => {
            ...
            assert.fieldEquals("Dispute", submitted_1.params.dispute.toHexString(), "settlement", submitted_1.params.settlement.toHexString());

            handleResolutionSubmitted(submitted_2)

            assert.entityCount("Settlement", 2);
            assert.fieldEquals("Dispute", submitted_1.params.dispute.toHexString(), "settlement", submitted_2.params.settlement.toHexString());
        });
    });
})
