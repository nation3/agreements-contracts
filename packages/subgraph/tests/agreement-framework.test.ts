...
const AGREEMENT_POSITION_FINALIZED_EVENT_1 = createAgreementPositionUpdatedEvent(
    Bytes.fromI32(200),
    Address.fromString(ADDRESS_SAMPLE_1),
    BigInt.fromI32(1050),
    BigInt.fromI32(2)
...
const AGREEMENT_POSITION_FINALIZED_EVENT_2 = createAgreementPositionUpdatedEvent(
    Bytes.fromI32(200),
    Address.fromString(ADDRESS_SAMPLE_2),
    BigInt.fromI32(1090),
    BigInt.fromI32(2)
...
const AGREEMENT_POSITION_WITHDRAWN_EVENT_1 = createAgreementPositionUpdatedEvent(
    Bytes.fromI32(200),
    Address.fromString(ADDRESS_SAMPLE_1),
    BigInt.fromI32(1050),
    BigInt.fromI32(3)
...
describe("handling of AgreementPositionUpdated", () => {
    ...
    test("position disputed", () => {
        ...
        assertAgreementPosition(updated.id.toHexString().concat(updated.party.toHexString()), updated.party.toHexString(), updated.balance.toString(), "Disputed", updated.id.toHexString());
    });
    ...
    test("position withdraws", () => {
        ...
        assertAgreementPosition(updated.id.toHexString().concat(updated.party.toHexString()), updated.party.toHexString(), updated.balance.toString(), "Withdrawn", updated.id.toHexString());
    });
});
...
describe("handling of AgreementFinalized", () => {
    ...
    test("one agremeent finalized", () => {
        ...
        assertAgreementPosition(finalized.id.toHexString().concat(finalized.party.toHexString()), finalized.party.toHexString(), finalized.balance.toString(), "Finalized", finalized.id.toHexString());
        assertAgreementPosition(finalized2.id.toHexString().concat(finalized2.party.toHexString()), finalized2.party.toHexString(), finalized2.balance.toString(), "Finalized", finalized2.id.toHexString());
    });
});
...
describe("handling of AgreementDisputed", () => {
    ...
    test("one agreement disputed", () => {
        ...
        assertAgreementPosition(joined.id.toHexString().concat(joined.party.toHexString()), joined.party.toHexString(), joined.balance.toString(), "Disputed", joined.id.toHexString())
        assertAgreementPosition(joined2.id.toHexString().concat(joined2.party.toHexString()), joined2.party.toHexString(), joined2.balance.toString(), "Joined", joined2.id.toHexString())
